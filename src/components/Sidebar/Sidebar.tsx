...
export const Sidebar = () => {
	...
	return (
		<aside className="sidebar z-10 flex h-screen w-1/6 max-w-[250px] flex-col items-center gap-y-16 bg-primary-white pt-10 shadow-[1px_0_9px_0_rgba(0,0,0,0.1)]">
			<div className="logo">
				<Link to="/Dashboard">
					<img src={Logo} alt="RoyalGlassSupplyLogo" />
				</Link>
			</div>
				...
				{SidebarData.map((item, index) => (
					...
					>
						...
						{item.subMenu && activeSubMenu === item.title && (
							<ul className="submenu-active absolute left-full top-0 z-10 w-full rounded rounded-bl-none rounded-br rounded-tl-none rounded-tr border-b border-r border-t bg-primary-white font-semibold shadow-[2px_0_10px_0] shadow-black/10">

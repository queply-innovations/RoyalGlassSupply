...
export const GrossAndNetProfit: React.FC = () => {
	...
	return (
		<>
			<div
				className="gross-and-netprofit-chart flex h-full min-h-[370px] w-[70%] flex-col rounded-md border border-black/10 bg-white p-5"
				ref={ref}
			>
